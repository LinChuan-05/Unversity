...
-- 默认管理员
INSERT INTO users (userName, password, sex, email, role) VALUES ('admin', 'admin123', '男', 'admin@test.com', 'admin');

-- 示例科目
INSERT INTO exam (name, duration, description, maxAttempts) VALUES
    ('Java程序设计', 10, 'Java基础语法考试', 1),
    ('数据库原理', 15, 'SQL与关系数据库理论', 1);

-- 示例试题 (Java程序设计)
INSERT INTO question (title, optionA, optionB, optionC, optionD, answer, examId, score) VALUES
